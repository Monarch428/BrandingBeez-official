...
//         window.scrollTo({
//           top: currentScroll - viewportHeight * 0.9, 
//           behavior: 'smooth',
//         });
//       }
//     }
...
//       {/* Modal container */}
//       <div
//         className={`relative z-50 w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-all duration-300 transform ${isClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
//           }`}
//       >
//         {/* Close button */}
//         <button
