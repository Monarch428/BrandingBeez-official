...
export function ThankYouPopup({ 
  ...
  return (
    /* Fullscreen overlay with modal */
    <div className={`fixed inset-0 z-50 flex items-center justify-center px-4 py-8 overflow-y-auto transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
      {/* Overlay background */}
      <div
      ...
      {/* Modal container */}
      <div className={`relative z-50 w-full max-w-md my-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-all duration-300 transform ${
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6 border border-blue-200 dark:border-blue-800">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
              ...
              <p>Our team will review your {formType === 'strategy' ? 'strategy request' : 'submission'} and contact you shortly to discuss how we can help.</p>
            </div>
          </div>
        </div>
