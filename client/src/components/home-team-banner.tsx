...
const teamMembers: TeamMember[] = [
  ...
  { name: "Praveen", role: "Full-Stack Dev", image: Praveen_Stroke, position: { x: 60, y: 45, scale: 0.7, delay: 2.4 } },
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl border border-white/20 p-4 sm:p-6 md:p-8">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-3 sm:gap-4 mb-4 sm:mb-6">
          {teamMembers.map((member, index) => (
            <div key={index} className="group text-center">
              <div className="relative mb-3">
                <div className="w-10 sm:w-12 md:w-14 lg:w-16 h-10 sm:h-12 md:h-14 lg:h-16 mx-auto relative">
