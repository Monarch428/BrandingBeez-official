        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 border-t border-gray-800">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              >
                <img src={designRushBadge} alt="BrandingBeez's rating on AI App Development Agency Listing by DesignRush, the industry-leading B2B Marketplace connecting brands with agencies" className="h-12 w-auto" loading="lazy" decoding="async" />
              </a>
              <a
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <a
                ...
                rel="noopener noreferrer"
                className="bg-white/10 backdrop-blur-sm rounded-lg p-4 flex items-center justify-center hover:bg-white/20 transition-all duration-300 border border-white/20">
                <img src={bniLogo} alt="BNI" className="h-12 w-auto object-contain" loading="lazy" decoding="async" />
              </a>
              <a
                href="#"
                target="_blank"
