...
export default function Footer() {
  ...
  // BrandingBeez White Logo - optimized for dark backgrounds
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <a
                  ...
                  className="hite transition-colors text-sm break-all touch-manipulation"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              >
                <img
                  src={designRushBadge}
                  alt="BrandingBeez's rating on AI App Development Agency Listing by DesignRush, the industry-leading B2B Marketplace connecting brands with agencies"
