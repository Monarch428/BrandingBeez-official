...
export function EntryPopup({ isOpen, onClose }: EntryPopupProps) {
  ...
  return (
    // ↓↓↓ This line is updated to show popup lower in the page ↓↓↓
    <div className="absolute left-1/2 top-[120vh] -translate-x-1/2 z-50 flex justify-center w-full px-4 sm:px-0">
      {/* Optional light background overlay (remove if not needed) */}
