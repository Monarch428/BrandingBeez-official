...
const teamMembers: TeamMember[] = [
  ...
  { name: "Azeez", role: "Graphic Designer", image: Azeez_Stroke, position: { x: 25, y: 5, size: 90 } },
  ...
  { name: "Praveen", role: "Full-Stack Developer", image: Praveen_Stroke, position: { x: 95, y: 5, size: 90 } },
