...
//                                                     className="mb-8 scroll-mt-20 flex items-center justify-between"
//                                                 >
...
//                                                             <Button asChild>
//                                                                 <a href={`/services/${group.category.id}`}>
//                                                                     Explore About {group.category.title} Service
//                                                                 </a>
//                                                             </Button>
//                                                         )}
//                                                 </div>
...
//                                                                                     className="flex items-center gap-1 text-sm font-medium text-brand-coral hover:underline"
//                                                                                 >
...
//                                                                         <p
//                                                                             className={`text-gray-700 text-sm leading-relaxed mb-4 transition-all ${isExpanded ? "" : "line-clamp-2"
//                                                                                 }`}
//                                                                         >
//                                                                             {item.description}
//                                                                         </p>
...
export default function PortfolioPage() {
    ...
    const testimonial_clients = [
        ...
        },
        {
            ...
            company: "Founder, Website Architect",
            testimonial:
                "Branding Beez have been a great help to my business. Before meeting Rale and her team, I was doing the sales, building the websites and handling all the tech and aftercare. Now I have the time to grow the business, working ON it, instead of constantly 'IN' it. So they've been a gamechanger for me and my business. Even taking my first holiday this year WITHOUT my laptop! Thanks so much!",
            imageUrl: Gemma_Image,
            logoUrl: webArtLogo,
        },
    ];
                ...
                <section className="min-h-screen bg-gray-50 py-16 px-4">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto text-[18px]">
                            ...
                            white-label solutions with care, speed, and attention to
                            detail.
                        </p>
