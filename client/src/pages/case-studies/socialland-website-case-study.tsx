              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>• Multiple service offerings</li>
                    <li>• Professional brand focus</li>
                  </ul>
                </Card>
                ...
                <Card className="p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>• Professional agency website</li>
                    <li>• Scalable architecture</li>
                    <li>• Service showcase platform</li>
                ...
                <Card className="p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>• First UK white-label project</li>
                    <li>• 2-year ongoing partnership</li>
                    <li>• Multiple client websites built</li>
                    <li>• Dedicated resource team setup</li>
                  </ul>
                </Card>
              </div>
            </div>
                    ...
                    <Card className="p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Comprehensive showcase of past work and client
                            success stories to demonstrate agency capabilities
                            and build trust.
                          </p>
                        </div>
                      </div>
