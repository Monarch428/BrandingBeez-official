...
//         <meta name="description" content="Build dedicated developer, design & specialist teams that integrate with your workflow. Scale faster with 150% output gains, 60% cost savings & quick setup." />
//         <link rel="canonical" href="https://brandingbeez.co.uk/services/dedicated-resources" />
          ...
          <section className="py-16 px-4 bg-gray-50">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
                ...
                {/* FSB Digital - Google Ads Specialist */}
                <Card className="bg-white h-full flex flex-col">
                  <CardContent className="p-8 flex-1 flex flex-col">
                    <div className="flex items-center justify-between mb-6">
                      <Badge className="bg-blue-100 text-blue-800 border-blue-200">
