  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Scale your agency with Branding Beez’s white-label SEO: local SEO, technical audits, content & reporting. Packages from $400/month." />
