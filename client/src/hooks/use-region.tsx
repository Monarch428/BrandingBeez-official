...
const regionConfigs: Record<Region, RegionConfig> = {
  ...
  UK: {
    ...
    calendlyUrl: import.meta.env.VITE_CALENDLY_UK_URL || "https://calendar.app.google/Y8XZq71qtvPRhktH9",
  ...
  DE: {
    ...
    calendlyUrl: import.meta.env.VITE_CALENDLY_DE_URL || "https://calendar.app.google/Y8XZq71qtvPRhktH9",
