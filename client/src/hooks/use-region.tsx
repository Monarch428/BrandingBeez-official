...
const regionConfigs: Record<Region, RegionConfig> = {
  US: {
    ...
    calendlyUrl: import.meta.env.VITE_CALENDLY_US_URL || "/book-appiontment",
  ...
  UK: {
    ...
    calendlyUrl: import.meta.env.VITE_CALENDLY_UK_URL || "/book-appiontment",
  ...
  DE: {
    ...
    calendlyUrl: import.meta.env.VITE_CALENDLY_DE_URL || "/book-appiontment",
